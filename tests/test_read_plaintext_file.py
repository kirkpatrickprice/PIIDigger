...
@pytest.mark.parametrize('filename, expected_result', [
                            ...
                            ('testdata/plaintext/lorem-ipsum-1line-utf8-crlf.txt', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'),
                            ('testdata/plaintext/lorem-ipsum-1line-with-blank-ending-line-utf16le-crlf.txt', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'),
                            ('testdata/plaintext/lorem-ipsum-1line-with-blank-ending-line-utf8-crlf.txt', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'),
                            ('testdata/plaintext/lorem-ipsum-1line-with-blank-ending-line-utf8-lf.txt', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'),
...
def test_read_plaintext_file(filename, expected_result):
    ...
    for result in plaintext.readFile(filename, logConfig):
        result += result
